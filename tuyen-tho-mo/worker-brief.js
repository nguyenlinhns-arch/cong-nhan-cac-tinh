(() => {
  ...
  const facts = [
    ...
    ["work", "Việc làm và thu nhập", "Làm việc tại Quảng Ninh", "Được bố trí việc làm sau đào tạo; Thu nhập 20–25 triệu đồng/tháng khi hoàn thành định mức lao động.", "/#noi-lam-viec"],
