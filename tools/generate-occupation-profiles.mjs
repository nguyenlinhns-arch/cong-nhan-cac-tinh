...
const profileCards = profiles.map((profile, profileIndex) => {
  ...
  const action = profile.active_intake ? "Xem tin tuyển dụng" : "Hỏi chỉ tiêu nghề cơ điện";
...
<link rel="stylesheet" href="/content-network.css?v=2"><link rel="stylesheet" href="/worker-questions.css?v=2"><link rel="stylesheet" href="/mobile-core.css?v=1"><link rel="stylesheet" href="/fonts.css?v=1"><link rel="stylesheet" href="/mobile-polish-20260803.css?v=3"><link rel="stylesheet" href="/site-shell-20260803.css?v=3">
<script type="application/ld+json">${JSON.stringify(structured)}</script></head>
<body class="worker-question-page"><a class="network-skip" href="#noi-dung">Đến nội dung chính</a><header class="network-header"><div class="network-wrap network-header__inner"><a class="network-brand" href="/" aria-label="Trang chủ Thầy Linh"><img src="/assets/thay-linh-avatar.webp?v=3" alt="" width="44" height="44"><span><strong>Thầy Linh</strong><small>Tuyển Thợ Mỏ</small></span></a><nav class="network-nav" aria-label="Thông tin nghề mỏ"><a href="/hoi-dap-di-lam-mo-than-quang-ninh/">20 câu hỏi</a><a href="/thong-tin-tuyen-tho-mo/">Thông tin chuẩn</a><a href="/viec-lam-nganh-than/">Theo tỉnh</a><a href="/cam-nang-nghe-mo/">Cẩm nang</a></nav><a class="network-apply" href="/kiem-tra-dieu-kien/" data-contact="condition" data-context="occupation-header">Kiểm tra điều kiện</a></div></header>
<main id="noi-dung"><section class="wq-hero"><div class="network-wrap wq-hero__grid"><div><p class="network-eyebrow">MÔ TẢ NGHỀ ĐÃ ĐỐI CHIẾU</p><h1>Nghề mỏ hầm lò gồm những nghề gì?</h1><p class="wq-hero__lead">Ba nhóm nghề chính gồm <strong>kỹ thuật khai thác mỏ hầm lò</strong>, <strong>kỹ thuật xây dựng mỏ hầm lò</strong> và <strong>kỹ thuật cơ điện mỏ hầm lò</strong>. Mỗi nghề đảm nhận một mắt xích khác nhau trong dây chuyền sản xuất, nhưng đều cần được đào tạo bài bản, phối hợp tổ đội và tuân thủ quy trình.</p><div class="wq-actions"><a class="wq-button wq-button--hot" href="/kiem-tra-dieu-kien/">Kiểm tra điều kiện</a><a class="wq-button" href="/viec-lam/cong-nhan-mo-ham-lo-quang-ninh/">Xem tin tuyển dụng</a></div></div><aside class="wq-answer"><small>THU NHẬP HIỆN HÀNH</small><strong>20–25 triệu đồng/tháng khi hoàn thành định mức lao động</strong><p>Nghề khai thác và xây dựng mỏ đang tiếp nhận có thời gian học 2–3 tháng.</p></aside></div></section>
