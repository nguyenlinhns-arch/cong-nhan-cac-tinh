...
const footer = `
  <footer class="site-footer">
    <div class="container footer-grid">
      <div><a class="brand brand-light" href="/"><span class="brand-mark">TL</span><span><strong>Thầy Linh</strong><small>Cổng kiểm chứng nghề mỏ</small></span></a><p>Thông tin để người lao động tự kiểm chứng trước khi đăng ký học nghề mỏ.</p></div>
...
<body class="verification-page">
  ...
  <header class="site-header">
    <div class="container header-inner">
      <a class="brand" href="/" aria-label="Trang chủ Thầy Linh"><span class="brand-mark">TL</span><span><strong>Thầy Linh</strong><small>Cổng kiểm chứng nghề mỏ</small></span></a>
      ${portalNav}
