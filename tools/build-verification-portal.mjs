    ...
    <section class="verification-page__section">
      <div class="container">
        ...
        <div class="verification-comparison"><table><thead><tr><th>Tiêu chí</th><th>Làm tại khu công nghiệp</th><th>Học nghề và làm mỏ</th></tr></thead><tbody>
          ...
          <tr><td>Thu nhập</td><td>Biến động theo địa phương, nhà máy, tăng ca, tay nghề và vị trí; cần đọc đúng hợp đồng của nơi tuyển.</td><td>Thông tin tuyển sinh đang áp dụng nêu mức 20–25 triệu đồng/tháng khi hoàn thành định mức lao động.</td></tr>
  ...
  },
  {
    ...
    <section class="verification-page__section">
      <div class="container">
        ...
        <div class="verification-card-grid">
          <article class="verification-card"><h3>Lương thợ lò sau đào tạo</h3><p><strong>20–25 triệu đồng/tháng khi hoàn thành định mức lao động.</strong></p><p>Mức này không phải khoản trả cho người chưa đi làm hoặc chưa hoàn thành nhiệm vụ.</p></article>
          ...
          <article class="verification-card"><h3>Hỗ trợ sinh hoạt</h3><p>Được hỗ trợ 7,5 triệu đồng/tháng trong thời gian học theo thông tin tuyển sinh đang áp dụng.</p></article>
