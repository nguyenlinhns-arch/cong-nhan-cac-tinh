      ...
      if (section.title === "Doanh nghiệp công bố thu nhập thợ lò trên 26 triệu đồng/tháng") {
        return {
          ...
          paragraphs: [
            ...
            "Với chương trình tuyển sinh đang áp dụng, người lao động hoàn thành định mức được cam kết thu nhập 20–25 triệu đồng/tháng. Đây là nền tảng để người đăng ký cân nhắc học nghề mỏ và xây dựng kế hoạch làm việc lâu dài tại Quảng Ninh.",
          ],
        };
      }
