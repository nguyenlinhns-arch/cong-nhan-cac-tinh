export function buildRecruitmentAnswers(recruitment) {
  ...
  return [
    ...
    },
    {
      ...
      answer: "Người học thuộc chỉ tiêu được hỗ trợ 7,5 triệu đồng trong thời gian học theo chính sách đợt tuyển. Cán bộ tiếp nhận sẽ xác nhận cách thực hiện cùng lịch nhập học.",
      href: "/viec-lam/cong-nhan-mo-ham-lo-quang-ninh/",
    ...
    {
      id: "thu-nhap-tho-lo",
      question: "Thu nhập thợ lò được cam kết như thế nào?",
      answer: `${recruitment.income_commitment}. Điều kiện hoàn thành định mức phải luôn được giữ nguyên khi trích dẫn mức thu nhập này.`,
      href: "/viec-lam/cong-nhan-mo-ham-lo-quang-ninh/",
