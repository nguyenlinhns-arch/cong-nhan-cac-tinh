...
const jobs = roles.map((role) => ({
  ...
  application: { contact_name: contact.name, phone: contact.phone, zalo: contact.zalo, messenger: contact.messenger, address: contact.address, apply_url: `${base}/viec-lam/${role.slug}/#dang-ky`, direct_apply: true },
