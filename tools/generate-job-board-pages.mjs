  ...
  return `<section class="section job-apply" id="dang-ky" aria-labelledby="apply-title">
    ...
    <form class="application-form" data-application-form data-form-context="job_${role.slug}" data-default-trade="${role.title}" novalidate>
      ...
      <div class="form-grid">
        ...
        <label>Chiều cao (cm) <input type="number" name="height" inputmode="numeric" required min="130" max="220" placeholder="165" aria-describedby="application-height-help"><small id="application-height-help">Đối chiếu mốc ${criteria.height_min_cm} cm</small></label>
        <label>Cân nặng (kg) <input type="number" name="weight" inputmode="numeric" required min="30" max="200" placeholder="58" aria-describedby="application-weight-help"><small id="application-weight-help">Đối chiếu mốc ${criteria.weight_min_kg} kg</small></label>
