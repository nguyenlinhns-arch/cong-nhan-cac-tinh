...
function plainDescription(role) {
  return `${organization} tổ chức tuyển lao động, cử đi học nghề ${role.short} để làm việc tại Quảng Ninh. Thời gian học 2–3 tháng. Điều kiện: nam 18–40 tuổi, cao từ 1,53 m, nặng từ 47 kg, sức khỏe tốt, đọc và viết thành thạo; không yêu cầu kinh nghiệm. Quyền lợi: miễn kinh phí đào tạo; hỗ trợ 7,5 triệu đồng trong thời gian học theo chính sách đợt tuyển; miễn phí ba bữa mỗi ngày với mức ăn 90.000 đồng/ngày; miễn phí ký túc xá. Thực tập hưởng 85–100% lương công nhân trong cùng dây chuyền. Sau tốt nghiệp được doanh nghiệp tiếp nhận ký hợp đồng lao động, bố trí đúng nghề; cam kết thu nhập 20–25 triệu đồng/tháng khi hoàn thành định mức lao động. Tiếp nhận liên tục trong năm 2026.`;
}

function htmlDescription(role) {
  return `<p>${role.responsibility}</p><p><strong>Điều kiện:</strong> nam 18–40 tuổi, cao từ 1,53 m, nặng từ 47 kg, sức khỏe tốt, đọc và viết thành thạo; không yêu cầu kinh nghiệm.</p><p><strong>Đào tạo và quyền lợi:</strong> học nghề 2–3 tháng; miễn kinh phí đào tạo; hỗ trợ 7,5 triệu đồng theo chính sách đợt tuyển; miễn phí ba bữa/ngày với mức ăn 90.000 đồng/ngày; miễn phí ký túc xá; thực tập hưởng 85–100% lương công nhân trong cùng dây chuyền.</p><p><strong>Sau đào tạo:</strong> doanh nghiệp tiếp nhận ký hợp đồng lao động, bố trí đúng nghề tại Quảng Ninh; cam kết thu nhập 20–25 triệu đồng/tháng khi hoàn thành định mức lao động.</p>`;
}
...
<body>
  ...
  <main id="noi-dung">
    ...
    <section class="job-hero" aria-labelledby="job-title">
      <div class="job-hero__copy"><p class="eyebrow eyebrow--light">TUYỂN DỤNG · QUẢNG NINH · 2026</p><h1 id="job-title">${role.title}</h1><p class="job-hero__lead">Học nghề 2–3 tháng để bước vào một công việc cần tay nghề, kỷ luật và tinh thần đồng đội – với cam kết thu nhập 20–25 triệu đồng/tháng khi hoàn thành định mức lao động tại Quảng Ninh.</p><div class="job-hero__facts"><span><b>18–40</b> tuổi</span><span><b>1m53</b> trở lên</span><span><b>47kg</b> trở lên</span><span><b>20–25 triệu</b>/tháng</span></div><div class="contact-pair contact-pair--hero"><a class="contact-button contact-button--zalo" href="${applicationUrl}"><span class="contact-icon contact-icon--text">✓</span><span><small>Chưa cần hồ sơ</small><strong>Ứng tuyển nhanh</strong></span></a><a class="contact-button contact-button--messenger" href="https://m.me/thaylinhtuyenthomo" target="_blank" rel="noopener noreferrer"><span class="contact-icon contact-icon--text">M</span><span><small>Nhắn Fanpage</small><strong>Messenger</strong></span></a></div></div>
...
const jobs = roles.map((role) => ({
  ...
  requirements: { gender: "Nam", age_min: 18, age_max: 40, height_min_cm: 153, weight_min_kg: 47, health: "Sức khỏe tốt", education: "Đọc và viết thành thạo; trình độ cụ thể đối chiếu theo hệ đào tạo", experience: "Không yêu cầu" },
  compensation: { currency: "VND", period: "MONTH", min: 20000000, max: 25000000, note: "Cam kết thu nhập 20–25 triệu đồng/tháng khi hoàn thành định mức lao động." },
  benefits,
