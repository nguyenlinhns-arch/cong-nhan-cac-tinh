...
<head>
  ...
  <link rel="stylesheet" href="/content-network.css?v=1"><link rel="stylesheet" href="/mobile-ux.css?v=4">
...
<body>
  ...
  ${footer()}
  <script src="/analytics.js?v=5" defer></script><script src="/mobile-ux.js?v=3" defer></script>${shareTools ? '<script src="/share-tools.js?v=1" defer></script>' : ""}
</body>
</html>`;
}
