...
<section class="network-section"><div class="network-wrap"><div class="network-heading"><div><p class="network-eyebrow">NGƯỜI BIÊN SOẠN · CÁCH THỰC HIỆN · MỤC ĐÍCH</p><h2>Người đọc biết rõ ai chịu trách nhiệm cho từng thông tin</h2></div><p>Website do Nguyễn Tử Linh – Trưởng phòng Tuyển sinh Miền Trung – biên soạn và duy trì để người lao động kiểm tra điều kiện, hiểu chương trình học nghề và biết đúng đầu mối trước khi quyết định.</p></div><ul class="network-list"><li><b>1</b><div><strong>Ai chịu trách nhiệm</strong><span>Nguyễn Tử Linh chịu trách nhiệm nội dung tuyển sinh, hồ sơ, địa chỉ tiếp nhận và hướng dẫn liên hệ trên website.</span></div></li><li><b>2</b><div><strong>Ba định dạng biên tập</strong><span>Một sự kiện chỉ có một nguồn được trình bày thành bản tin dữ kiện ngắn; nhân vật được làm thành hồ sơ người thợ; bài phân tích dài phải có góc riêng, nhiều nguồn hoặc tư liệu thực tế.</span></div></li><li><b>3</b><div><strong>Vì sao nội dung được xuất bản</strong><span>Mục tiêu là giúp người lao động và gia đình hiểu điều đáng biết, không kéo dài thông cáo thành bài báo và không tạo bài chỉ để lặp từ khóa tìm kiếm.</span></div></li></ul></div></section>
