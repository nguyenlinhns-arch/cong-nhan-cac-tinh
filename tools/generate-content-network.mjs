...
const jobsDescription = "Việc làm công nhân mỏ, thợ lò tại Quảng Ninh cho nam 18–40 tuổi; xem hai nghề đang tuyển và thông tin tư vấn dành cho người lao động tại 26 tỉnh.";
const jobItems = [
...
writePage("viec-lam-nganh-than", page({pathName: "/viec-lam-nganh-than/", title: "Việc làm công nhân mỏ, thợ lò theo tỉnh", description: jobsDescription, eyebrow: "VIỆC LÀM NGÀNH THAN 2026", heading: "Việc làm công nhân mỏ, thợ lò theo tỉnh", lead: "Hai nghề mỏ hầm lò đang tiếp nhận; người chưa có kinh nghiệm được đào tạo từ đầu tại Quảng Ninh trước khi nhận việc.", body: jobsBody, schema: commonSchema({pathName: "/viec-lam-nganh-than/", title: "Việc làm công nhân mỏ, thợ lò theo tỉnh", description: jobsDescription, items: jobItems})}));
