...
for (const hook of [
  ...
  "recruitment-config.js?v=1",
  "job-application.js?v=4",
]) requireText(campaign, hook, "central application page");

for (const field of ["full_name", "phone", "birth_date", "province", "height", "weight", "education", "trade", "health"]) {
...
for (const marker of ["deliverApplication(application)", "Content-Type\": \"text/plain", "application_saved", "values.consent === \"on\""]) {
