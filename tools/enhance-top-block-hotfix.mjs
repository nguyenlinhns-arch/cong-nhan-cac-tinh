...
const STYLE_TAG = '<link rel="stylesheet" href="/site-shell-20260803.css?v=3">';
const SCRIPT_TAG = '<script src="/site-shell-20260803.js?v=3" defer></script>';
let checked = 0;
let changed = 0;
let withShell = 0;
...
for (const target of walk(root)) {
  ...
  if (relative === "index.html" || relative === "tuyen-tho-mo-quang-ninh/index.html" || before.includes("data-legacy-redirect") || /^google[a-z0-9_-]+\.html$/i.test(relative)) continue;
  checked += 1;
