...
for (const article of dailyCommunityArticles20260831) {
  ...
  try {
    ...
    const extracted = source.imageRelationship === "FIRST_CONTENT_IMAGE" && sourceContainsExpected
      ? source.image
...
if (new Set(dailyCommunityArticles20260831.map((article) => article.image)).size !== dailyCommunityArticles20260831.length) errors.push("Ảnh đại diện trong lượt 31/08 bị trùng nhau");
