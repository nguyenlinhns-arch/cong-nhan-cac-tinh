...
function fullInfoPage() {
  ...
  const faq = [
    ...
    ["Trong thời gian học được hỗ trợ gì?", "Người học theo chỉ tiêu được miễn kinh phí đào tạo, bố trí ba bữa ăn mỗi ngày, ở ký túc xá và hỗ trợ 7,5 triệu đồng trong thời gian học."],
    ...
    ["Thu nhập sau đào tạo thế nào?", "Thông tin tuyển sinh đang áp dụng cam kết thu nhập 20–25 triệu đồng/tháng khi hoàn thành định mức lao động."],
  ];
...
function updateSearchIndex() {
  ...
  const item = {
    ...
    description: "Điều kiện, nơi học tại Quang Hanh, thời gian 2–3 tháng, ăn ở, hỗ trợ 7,5 triệu, hồ sơ và việc làm sau đào tạo.",
    keywords: ["học nghề mỏ tại Quảng Ninh", "học nghề thợ lò", "Quang Hanh", "học 2–3 tháng", "ăn ở khi học", "hỗ trợ 7,5 triệu", "hồ sơ nhập học", "việc làm ngành Than"],
