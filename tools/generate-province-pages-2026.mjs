  ...
  <main id="noi-dung">
    ...
    <section class="local-hero" aria-labelledby="local-title">
      <div class="local-hero__copy">
        ...
        <p class="local-hero__lead">Người phù hợp được đào tạo nghề, hỗ trợ ăn ở trong khóa học và có cơ hội xây dựng mức thu nhập tham khảo 20–25 triệu đồng/tháng bằng tay nghề, ngày công và năng suất.</p>
