...
for (const article of dailyCommunityArticles20260828) {
...
if (new Set(dailyCommunityArticles20260828.map((article) => article.image)).size !== dailyCommunityArticles20260828.length) errors.push("Ảnh đại diện trong lượt 28/08 bị trùng nhau");
