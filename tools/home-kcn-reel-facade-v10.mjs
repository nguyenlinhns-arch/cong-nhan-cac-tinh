...
if (!alreadyFacade) {
  ...
  const facade = `<button class="home-video-facade home-kcn-reel-facade" type="button" data-facebook-reel-facade data-facebook-embed="${embed.replaceAll("&", "&amp;")}" aria-label="Phát video Làm mỏ hay KCN?"><span class="home-video-facade__play" aria-hidden="true">▶</span><span class="home-video-facade__label">Bấm để xem video · Làm mỏ hay KCN?</span></button>`;
