...
for (const article of dailyCommunityArticles20260821) {
...
if (new Set(dailyCommunityArticles20260821.map((article) => article.image)).size !== dailyCommunityArticles20260821.length) errors.push("Ảnh đại diện trong lượt 21/08 bị trùng nhau");
