...
for (const article of dailyCommunityArticles20260822) {
...
if (new Set(dailyCommunityArticles20260822.map((article) => article.image)).size !== dailyCommunityArticles20260822.length) errors.push("Ảnh đại diện trong lượt 22/08 bị trùng nhau");
