const contextBySlug = {
  "bua-com-cong-doan-than-cao-son-2026": "Với khai trường rộng và công việc theo ca, bữa ăn ảnh hưởng trực tiếp tới khả năng hồi phục thể lực; vì vậy chất lượng suất ăn và việc giao đúng vị trí cần được theo dõi như một phần của điều kiện làm việc.",
  "hoc-sinh-thuc-tap-than-khe-cham-2026": "Giai đoạn thực tập quyết định khả năng chuyển kiến thức trên lớp thành kỹ năng, tác phong và khả năng thích nghi; theo dõi sát ở chặng này giúp người học và doanh nghiệp phát hiện sớm những điểm chưa phù hợp trước khi kết thúc chương trình.",
