...
const topics = [
  ["dieu-kien-tuyen-tho-lo-2026","Điều kiện tuyển thợ lò 2026: kiểm tra trước khi đăng ký","điều kiện tuyển thợ lò 2026","Điều kiện cơ bản gồm độ tuổi, thể lực và sức khỏe; kết quả cuối cùng căn cứ kiểm tra của đơn vị tiếp nhận.","entry",["Nam 18–35 tuổi là nhóm đang được sàng lọc","Chiều cao từ 1m56","Cân nặng từ 48kg","Sức khỏe phải phù hợp nghề nặng nhọc","Nên gửi đủ ba thông tin trước khi chuẩn bị hồ sơ"]],
  ...
  ["ho-so-hoc-nghe-mo-can-gi","Hồ sơ học nghề mỏ cần gì? Danh sách ngắn dễ nhớ","hồ sơ học nghề mỏ cần gì","Hồ sơ dự tuyển gồm 02 bộ: sơ yếu lý lịch, giấy khai sinh, bằng tốt nghiệp văn hóa và căn cước công dân.","entry",["Căn cước công dân cần bản công chứng","Giấy khai sinh dùng để đối chiếu thông tin","Bằng tốt nghiệp văn hóa cần bản công chứng","Sơ yếu lý lịch cần có trong mỗi bộ","Chuẩn bị đủ 02 bộ hồ sơ theo hướng dẫn"]],
  ["tuoi-hoc-nghe-mo-va-lam-tho-lo","Bao nhiêu tuổi có thể học nghề mỏ và làm thợ lò?","tuổi học nghề mỏ","Người từ 18 đến 35 tuổi có thể gửi thông tin kiểm tra ban đầu, sau đó tiếp tục xét sức khỏe và tiêu chí của đợt tuyển.","entry",["Đủ 18 tuổi mới thuộc nhóm lao động trưởng thành","Mốc 35 tuổi là tiêu chí sàng lọc hiện hành","Tuổi phù hợp chưa đồng nghĩa chắc chắn trúng tuyển","Sức khỏe và thể lực vẫn là điều kiện quan trọng","Nên kiểm tra trước khi đi xa"]],
  ["chieu-cao-can-nang-tuyen-tho-lo","Chiều cao, cân nặng tuyển thợ lò: cách tự kiểm tra","chiều cao cân nặng tuyển thợ lò","Mốc hiện hành là từ 1m56 và 48kg; nên đo đúng thay vì ước lượng.","entry",["Đo chiều cao không mang giày","Cân vào thời điểm cơ thể ổn định","Không làm tròn số quá nhiều","Thể lực thực tế còn được đánh giá khi khám","Kết hợp ngủ đủ và ăn uống bình thường trước kiểm tra"]],
...
const sitemap = `<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n${urls.map(url => {
  ...
  return `  <url><loc>${url}</loc><lastmod>2026-07-31</lastmod><changefreq>${url.includes("/bai-viet/") ? "monthly" : "weekly"}</changefreq><priority>${priority}</priority></url>`;
}).join("\n")}\n</urlset>\n`;
