...
function normalizePageAssets(html, file) {
  ...
  output = output.replace(/\/mobile-ux\.js\?v=\d+/g, "/mobile-ux.js?v=7");
...
for (const article of existingNews) {
  ...
  html = html.replace(/\/analytics\.js\?v=\d+/g, '/analytics.js?v=5').replace(/\/mobile-ux\.js\?v=\d+/g, '/mobile-ux.js?v=7').replace(/\/mobile-ux\.css\?v=\d+/g, '/mobile-ux.css?v=5').replace(/\/job-application\.js\?v=\d+/g, '/job-application.js?v=9');
