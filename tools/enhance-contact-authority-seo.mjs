    ...
    <section class="contact-authority__section">
      <div class="network-wrap">
        ...
        <div class="contact-authority__grid">
          ...
          <article><b>04</b><h3>Lộ trình nhận việc sau đào tạo</h3><p>Giải thích nơi làm việc, quy trình tiếp nhận và cam kết thu nhập 20–25 triệu đồng/tháng khi hoàn thành định mức lao động.</p></article>
        </div>
      </div>
    </section>
